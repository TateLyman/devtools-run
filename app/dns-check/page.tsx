...
export default function Page() {
  ...
  return (
    <div className="space-y-6">
      <section className="text-center"><h1 className="text-4xl font-bold mb-2">DNS Lookup Tool</h1><p className="text-[var(--text-secondary)]">Look up DNS records for any domain</p></section>
