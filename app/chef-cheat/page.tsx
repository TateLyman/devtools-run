...
export default function Page() {
  return (
    <div className="space-y-6">
      <section className="text-center"><h1 className="text-4xl font-bold mb-2">Chef Cheatsheet</h1><p className="text-[var(--text-secondary)]">Chef automation reference</p></section>
