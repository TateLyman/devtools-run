...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const tools = [
    ...
    "minesweeper", "wordle", "tax-calculator", "sudoku", "download-calculator", "pixel-converter", "color-gradient", "morse-code", "roman-numeral", "number-converter", "hex-to-color", "ascii-art-text", "password-strength", "emoji-search", "reading-time", "percent-calc", "screen-resolution",
  ];
