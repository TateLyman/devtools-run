...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const products = [
    ...
    "github-readme", "case-converter", "hash-text", "base-converter", "jwt-decode", "css-variables", "pixel-editor", "todo-list", "gitignore", "npm-name",
    ...
    "base-converter", "jwt-decode", "css-variables", "pixel-editor", "todo-list", "jwt-create", "cron-monitor", "marketplace",
