...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const tools = [
    ...
    "lorem", "html-entities", "flexbox-playground", "slug-generator", "grid-playground", "text-diff-checker", "markdown", "qr", "diff", "aspect-ratio", "yaml-json",
