...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const tools = [
    ...
    "lorem", "html-entities", "flexbox-playground", "slug-generator", "grid-playground", "text-diff-checker", "aspect-ratio-calc", "unicode-search", "shadow-gen", "json-pretty", "color-harmonies", "focus-timer", "electricity-cost", "bmr-calculator", "savings-goal", "wifi-password", "typing-challenge", "ip-geolocation", "md-live", "animation-gen", "json-path", "regex-cheat", "git-cheat", "http-codes", "keyboard-shortcuts", "epoch-converter", "css-filter", "pw-gen", "text-gradient", "placeholder-image", "meta-gen", "clip-path-gen", "data-size", "utm-builder", "specificity-calc", "github-readme-gen", "transition-gen", "markdown", "qr", "diff", "aspect-ratio", "yaml-json",
