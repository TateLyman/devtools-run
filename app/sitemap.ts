...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const products = [
    ...
    "github-readme", "case-converter", "hash-text", "base-converter", "jwt-decode", "css-variables", "pixel-editor", "todo-list", "csv-viewer", "email-sig", "link-checker", "json-escape", "gitignore", "npm-name",
    "og-preview", "image-compress", "csv-viewer", "email-sig", "link-checker", "json-escape", "robots-generator",
    "font-pairs", "calculator", "token-research", "playground",
    "tech-detector", "readme", "color-name", "notes", "todo", "whiteboard",
    "base-converter", "jwt-decode", "css-variables", "pixel-editor", "todo-list", "csv-viewer", "email-sig", "link-checker", "json-escape", "jwt-create", "cron-monitor", "marketplace",
