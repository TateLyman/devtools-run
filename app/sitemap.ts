...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const products = [
    ...
    "github-readme", "case-converter", "hash-text", "base-converter", "jwt-decode", "css-variables", "gitignore", "npm-name",
    ...
    "base-converter", "jwt-decode", "css-variables", "jwt-create", "cron-monitor", "marketplace",
