...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const products = [
    ...
    "github-readme", "case-converter", "hash-text", "base-converter", "jwt-decode", "css-variables", "pixel-editor", "todo-list", "csv-viewer", "email-sig", "link-checker", "json-escape", "htaccess-gen", "image-gallery", "image-resize", "gitignore", "npm-name",
    "og-preview", "image-compress", "csv-viewer", "email-sig", "link-checker", "json-escape", "htaccess-gen", "image-gallery", "image-resize", "robots-generator",
    "font-pairs", "calculator", "token-research", "playground",
    "tech-detector", "readme", "color-name", "notes", "todo", "whiteboard",
    "base-converter", "jwt-decode", "css-variables", "pixel-editor", "todo-list", "csv-viewer", "email-sig", "link-checker", "json-escape", "htaccess-gen", "image-gallery", "image-resize", "jwt-create", "cron-monitor", "marketplace",
