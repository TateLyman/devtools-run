...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const tools = [
    ...
    "lorem", "html-entities", "flexbox-playground", "slug-generator", "grid-playground", "text-diff-checker", "aspect-ratio-calc", "unicode-search", "shadow-gen", "json-pretty", "color-harmonies", "focus-timer", "github-readme-gen", "transition-gen", "markdown", "qr", "diff", "aspect-ratio", "yaml-json",
    ...
    "minesweeper", "wordle", "tax-calculator", "sudoku", "download-calculator", "pixel-converter", "color-gradient", "morse-code", "roman-numeral", "number-converter", "hex-to-color", "ascii-art-text", "password-strength", "emoji-search", "reading-time", "percent-calc", "screen-resolution", "internet-speed", "image-colors", "json-to-csv-converter", "tts", "markdown-table", "border-radius-gen", "cron-explain", "jwt-generator", "contrast-checker", "favicon-maker", "notepad", "my-ip", "random-color", "countdown-to", "lorem", "html-entities", "flexbox-playground", "slug-generator", "grid-playground", "text-diff-checker", "aspect-ratio-calc", "unicode-search", "shadow-gen", "json-pretty", "color-harmonies", "focus-timer", "github-readme-gen", "transition-gen",
  ];
