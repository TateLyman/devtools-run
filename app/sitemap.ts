...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const products = [
    ...
    "github-readme", "case-converter", "hash-text", "base-converter", "gitignore", "npm-name",
