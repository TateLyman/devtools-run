...
export default function Page() {
  ...
  return (
    <div className="space-y-6">
      <section className="text-center"><h1 className="text-4xl font-bold mb-2">IP to Binary</h1><p className="text-[var(--text-secondary)]">Convert IP address to binary</p></section>
